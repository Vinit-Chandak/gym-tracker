...
export const EXERCISES: readonly ExerciseSeed[] = [
  ...
  // --- Gym-floor variants the library was missing -----------------------------------------------
  // Movements people already train and log by name, where the nearest existing entry is a
  // different exercise rather than a different word for the same one. Anything the library
  // already covers under another name stays as it is; nothing here renames an existing slug.
  {
  ...
  },
  {
    ...
    defaultLoadIncrement: 2.5,
    formNotes:
      "Supinate as you curl; keep the elbow under the shoulder rather than drifting forward.",
    equipment: ["dumbbells"],
  },
  {
    slug: "machine-wrist-curl",
    ...
    defaultRestSeconds: 60,
    defaultLoadIncrement: null,
    formNotes: "Forearms flat on the pad. Move at the wrist only; the elbows stay where they are.",
    equipment: ["wrist_curl_machine"],
  },
  {
    slug: "neutral-grip-lat-pulldown",
    name: "Neutral-grip lat pulldown (D-handles)",
    category: "hypertrophy",
    modality: "machine",
    movementPattern: "vertical_pull",
    primaryMuscles: ["lats"],
    ...
    defaultLoadIncrement: null,
    formNotes:
      "Two independent D-handles, palms facing. Unlike a fixed V-bar each arm finds its own path, so drive the elbows down and in rather than pulling with the hands.",
    equipment: ["lat_pulldown", "functional_trainer"],
  },
  {
    slug: "chest-dip",
    name: "Parallel bar dip (chest-biased)",
    category: "hypertrophy",
    modality: "bodyweight",
    movementPattern: "vertical_push",
    primaryMuscles: ["chest"],
  ...
  },
  {
    ...
    defaultLoadIncrement: null,
    formNotes:
      "The wide setting on the seated dip machine, chest into the pad. The narrow setting is the triceps version and is logged as its own exercise.",
    equipment: ["triceps_dip_machine"],
  },
  {
    slug: "v-bar-overhead-cable-extension",
    name: "V-bar overhead cable triceps extension",
    category: "hypertrophy",
    modality: "cable",
    movementPattern: "elbow_extension",
    primaryMuscles: ["triceps"],
