...
export const STRENGTH_AESTHETICS_HYBRID_8WK: ProgramBlueprint = {
  ...
  // Effort is out of five, the scale the athlete answers on (0034). These were written out of
  // ten — 3–4, an easy talk-test run — and kept their numbers when the scale halved, which
  // made every easy run of this template read as a hard one.
  runs: [
    {
      weekIndex: 1,
      dayOfWeek: 4,
