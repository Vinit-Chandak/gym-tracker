...
ALTER TABLE "occurrence_events" ADD CONSTRAINT "occurrence_events_activity_fk" FOREIGN KEY ("user_id","activity_id") REFERENCES "public"."activities"("user_id","id") ON DELETE SET NULL ("activity_id") ON UPDATE no action;--> statement-breakpoint
