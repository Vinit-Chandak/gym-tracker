...
11. Accounts that know the person: a required first-run profile, emailed links that reach the deployed app, and body weight as a running record with a trend: done (ADR 0020).
