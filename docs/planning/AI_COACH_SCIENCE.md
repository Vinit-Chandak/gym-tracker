...
| ---------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Daily session preparation at 04:00 IST               | The user's chosen shared cadence in the owner's time zone and resource constraint. It is not a biologically privileged time to prescribe exercise.                                                    |
| One weekly review on the athlete's selected rest day | A predictable opportunity in the shared 04:00 IST run to evaluate evidence. A review can keep the program unchanged; seven days does not prove a plateau or demand a rewrite.                         |
